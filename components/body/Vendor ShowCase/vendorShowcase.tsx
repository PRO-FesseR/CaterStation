...
export default function VendorShowcase(){
    return(
        <section className="bg-white overflow-x-hidden h-auto md:h-screen flex md:flex-row flex-col w-full md:px-10 p-0 gap-0 md:gap-20 md:py-0 py-32  justify-around items-center">
            <article className="flex flex-col w-full md:w-[40%]">
                <h2 className={`${dancing_Script.className} text-[var(--color-accent-brand-blue)] md:text-7xl  text-4xl`}>Find the Best Vendors in Pakistan</h2>
