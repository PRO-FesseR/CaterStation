...
function TestimonialCard({
    ...
    return (
        <div
            className=" flex h-44 w-96 overflow-hidden rounded-xl border bg-background dark:border-zinc-700 transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:border-primary"
            key={name}
        >
